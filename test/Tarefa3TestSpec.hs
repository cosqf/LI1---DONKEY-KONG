...
testJogadorhit = TestList
    [ "Test 1: hp dimunui" ~:
        jogadorhit [Personagem {vida = 3, posicao = (0, 0)}] (Personagem {vida = 2}) ~?= (Personagem {vida = 1})
    , "Test 2: hp não muda" ~:
        jogadorhit [Personagem {vida = 3, posicao = (0, 0)}] (Personagem {vida = 3}) ~?= (Personagem {vida = 3})
    ]
